...
export function Dates(){
    return(
      <div className="relative min-h-[50vh] mb-10">
        <h2 className="my-14 text-center text-2xl md:text-4xl font-bold textDegrad">Próximos eventos</h2>
        <div id="containerDates" className="flex justify-around items-center">
          <a className="Links w-[80%] md:w-auto m-auto" href="https://www.passline.com/eventos/magic-men-325883" target='_blank'>
            ...
            <span className='text-sm md:text-3xl font-bold'>8 de marzo - Argentina</span>
          </a>
        </div>
      </div>
    )
