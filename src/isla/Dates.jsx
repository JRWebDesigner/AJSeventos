...
export function Dates(){
    return(
      <div className="relative min-h-[50vh] mb-10">
        <h2 className="my-14 text-center text-4xl font-bold">Touring Dates</h2>
        <div id="containerDates" className="flex justify-around items-center">
          <a className="Links" href="https://www.passline.com/eventos/magic-men-325883" target='_blank'>
            ...
            <span>8 de marzo - Argentina</span>
          </a>
        </div>
      </div>
    )
